...
class User(UserMixin, db.Model):
    ...
    default_palette_mood = db.Column(db.String(24), nullable=False, default="")
    default_typography_vibe = db.Column(db.String(24), nullable=False, default="")
    default_taste_keywords = db.Column(db.String(320), nullable=False, default="")
